...
class setting_config:
    ...
    if datasets == 'isic18':
        ...
        data_path = './data/PH2/'
    elif datasets == 'ClinicDB':
        data_path = './data/polyp_seg/ClinicDB/'
    elif datasets == 'ColonDB':
        data_path = './data/polyp_seg/ColonDB/'
    elif datasets == 'Kvasir':
        data_path = './data/polyp_seg/Kvasir/'
    elif datasets == 'ETIS':
        data_path = './data/polyp_seg/ETIS/'
    elif datasets == 'CVC_300':
        data_path = './data/polyp_seg/CVC_300/'
    ...
    # criterion = BceDiceLoss(wb=0.2, wd=0.8)
    # criterion = CNet_BceDiceLoss(wb=0.2, wd=0.8)
    criterion = boundary_BceDiceLoss(wb=0.2, wd=0.8)
    ...
    if opt == 'Adadelta':
        ...
        weight_decay = 0.005 # default: 1e-2 – weight decay coefficient
        amsgrad = False # default: False – whether to use the AMSGrad variant of this algorithm from the paper On the Convergence of Adam and Beyond
    elif opt == 'Adamax':
